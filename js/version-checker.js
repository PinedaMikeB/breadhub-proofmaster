/**
 * BreadHub ProofMaster - Version Checker
...
const VersionChecker = {
    ...
    versionKey: 'breadhub_proofmaster_version',
    lastCheckKey: 'breadhub_proofmaster_last_check',
    ...
    async init() {
        ...
        console.log(`BreadHub ProofMaster v${this.currentVersion}`);
    },
